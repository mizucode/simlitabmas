				...
				<div class='col-md-12'>
					<div class="card card-outline card-danger">
						<div class="card-header">
							<h3 class="card-title">Monograf</h3>
								...
								<div class="modal-body">
									<form role="form">
										<div class="form-group">
											<p>
											<label>Judul Monograf<span class="text-danger"> *</span></label>
											...
											<p>
											<label>ISBN</label>
											<input name="isbn" type="text" class="form-control" placeholder="Silakan diisi">
											</p>
											<p>
											...
											<select class='form-control' name='jenis_file' required>
												<option value=''>-- Pilih --</option>
												<?php
													$qkode3 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='file_monograf' ORDER BY id");
