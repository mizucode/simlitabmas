				...
				<div class='col-md-12'>
					<div class="card card-outline card-danger">
						<div class="card-header">
							<h3 class="card-title">Karya yang Tidak Memiliki Paten/HKI </h3>
						...
						<?php
							$no=1;
							$q = mysqli_query($con,"SELECT * FROM penelitian_karya,dosen WHERE penelitian_karya.nip_dosen=dosen.nik AND tgl_terbit>='$tgl_start' AND tgl_terbit<='$tgl_end' ORDER BY dosen.nik ");
							if(mysqli_num_rows($q)<1) {
								echo"<tr><td colspan='5'><p class='text-center text-danger'>Tidak ada data pada semester/TA yang dipilih</p></td></tr>";
							}
							else {
								while($r=mysqli_fetch_array($q)) {
									$id_jenis = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM kode WHERE value='$r[id_jenis]' AND kelompok='karya' LIMIT 1"));
									echo"
										<tr>
											<td>$no</td>
											<td>$r[name_glr]</td>
											...
											<td>
									";
									$qfile = mysqli_query($con,"SELECT fd.id,fd.url,kode.desc FROM file_dosen AS fd,kode WHERE fd.kelompok=kode.kelompok AND fd.value_kode=kode.value AND fd.id_cat='$r[id]' AND kode.kelompok='file_karya' ");
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form role="form" enctype="multipart/form-data" method="post" action="/insert/penelitian/karya">
										<div class="form-group">
											...
											<select class='form-control' name='id_jenis' required>
												...
												<?php
													$qkode1 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='karya' ORDER BY id");
											...
											<select class='form-control' name='jenis_file' required>
												<option value=''>-- Pilih --</option>
												<?php
													$qkode3 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='file_karya' ORDER BY id");
