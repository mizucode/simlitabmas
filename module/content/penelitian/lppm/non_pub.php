				...
				<div class='col-md-12'>
					<div class="card card-outline card-danger">
						<div class="card-header">
							<h3 class="card-title">Materi yang Disajikan tetapi Tidak Dipublikasikan</h3>
						...
						<?php
							$no=1;
							$q = mysqli_query($con,"SELECT * FROM penelitian_non_pub,dosen WHERE penelitian_buku.nip_dosen=dosen.nik AND tgl_pelaksanaan>='$tgl_start' AND tgl_pelaksanaan<='$tgl_end' ORDER BY dosen.nik ");
								...
								while($r=mysqli_fetch_array($q)) {
									echo"
										<tr>
											...
											<td>
									";
									$qfile = mysqli_query($con,"SELECT fd.id,fd.url,kode.desc FROM file_dosen AS fd,kode WHERE fd.kelompok=kode.kelompok AND fd.value_kode=kode.value AND fd.id_cat='$r[id]' AND kode.kelompok='file_non_pub' ");
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form role="form" enctype="multipart/form-data" method="post" action="/insert/penelitian/non_pub">
										<div class="form-group">
											...
											<p>
											<label>Nama Seminar/Pertemuan<span class="text-danger"> *</span></label>
											<input name="nama_seminar" type="text" class="form-control" placeholder="Silakan diisi" maxlength="4" required>
											</p>
											<p>
											...
											<input name="penyelenggara" type="text" class="form-control" placeholder="Silakan diisi" maxlength="4" required>
											</p>
											<p>
											<label>Bahasa</label>
											...
											<select class='form-control' name='jenis_file' required>
												<option value=''>-- Pilih --</option>
												<?php
													$qkode3 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='file_non_pub' ORDER BY id");
