				...
				<div class='col-md-12'>
					<div class="card card-outline card-danger">
						<div class="card-header">
							<h3 class="card-title">Kegiatan Pengabdian</h3>
						...
						<?php
							$no=1;
							$q = mysqli_query($con,"SELECT * FROM pengabdian_pengabdian,dosen WHERE pengabdian_pengabdian.nip_dosen=dosen.nik AND tgl_mulai_kegiatan>='$tgl_start' AND tgl_mulai_kegiatan<='$tgl_end' ORDER BY pengabdian_pengabdian.id_skema,pengabdian_pengabdian.judul_kegiatan ");
							if(mysqli_num_rows($q)<1) {
								echo"<tr><td colspan='6'><p class='text-center text-danger'>Tidak ada data pada semester/TA yang dipilih</p></td></tr>";
							}
							else {
								...
								while($r=mysqli_fetch_array($q)) {
									...
									echo"
										<tr>
											...
											<td>$skema[desc]</td>
											<td>$peran[desc]</td>
											<td>$r[tgl_mulai_kegiatan]</td>
											<td>
									";
									$qfile = mysqli_query($con,"SELECT fd.id,fd.url,kode.desc FROM file_dosen AS fd,kode WHERE fd.kelompok=kode.kelompok AND fd.value_kode=kode.value AND fd.id_cat='$r[id]' AND kode.kelompok='file_pengabdian' ");
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form role="form" enctype="multipart/form-data" method="post" action="/insert/pengabdian/pengabdian">
										<div class="form-group">
											...
											<select class='form-control' name='id_skema' required>
												...
												<?php
													$qkode1 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='skema_pengabdian' ORDER BY id");
											...
											<p>
											<label>Tanggal Mulai Kegiatan (<?php echo $tgl_start; ?> - <?php echo $tgl_end; ?>)<span class="text-danger"> *</span></label>
											<input name="tgl_mulai_kegiatan" type="date" class="form-control" min="<?php echo $tgl_start; ?>" max="<?php echo $tgl_end; ?>" required>
											</p>
											<p>
											...
											<select class='form-control' name='id_peran' required>
												<option value=''>-- Pilih --</option>
												<?php
													$qkode2 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='peran_pengabdian' ORDER BY id");
											...
											<input name="rujukan_ta" type="checkbox" value="Tidak"> Ya
											</p>
											<p>
											...
											<select class='form-control' name='jenis_file' required>
												<option value=''>-- Pilih --</option>
												<?php
													$qkode3 = mysqli_query($con,"SELECT * FROM kode WHERE kelompok='file_pengabdian' ORDER BY id");
